...
if (isset($_GET['delete'])) {
    $id = $_GET['delete'];
    $delete = mysqli_query($koneksi, "DELETE FROM level ORDER BY id='$id'");
...
<div align="right" class="mb-3">
    <a href="?pg=tambah_level" class="btn btn-primary">Tambah Level</a>
</div>
    ...
    <tbody>
        ...
        while ($row = mysqli_fetch_assoc($query)) : ?>
            <tr>
                ...
                <td><a href="?pg=tambah_level&edit=<?php echo $row['id'] ?>" class="btn btn-xs btn-danger">Edit</a> |
