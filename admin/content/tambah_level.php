...
if (isset($_POST['simpan'])) {
    ...
    $insert = mysqli_query($koneksi, "INSERT INTO level (nama_level, ket) VALUES ('$nama_level','$keterangan')");
...
if (isset($_POST['edit'])) {
    ...
    $update = mysqli_query($koneksi, "UPDATE level SET nama_level = '$nama_level', ket='$keterangan' WHERE id ='$id'");
...
<form action="" method="post">
    ...
    <div class="mb-3">
        ...
        <textarea name="keterangan" id="" class="form-control" placeholder="Masukkan Keterangan"><?php echo isset($_GET['edit']) ? $rowEdit['ket'] : '' ?></textarea>
    </div>
    <div class="mb-3">
